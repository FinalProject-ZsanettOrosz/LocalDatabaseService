...
@XmlType(propOrder = { "idPerson", "name", "lastname", "birthdate", "email",
		"username", "lifeStatus", "achivedGoals" })
//@XmlRootElement
public class Person implements Serializable {
	...
	@OneToMany(mappedBy = "person", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	@XmlElement(name = "achivedGoals")
	private List<AchivedGoal> achivedGoals;
	
	public void setAchivedGoals(AchivedGoal achivedGoals) {
		this.achivedGoals.add(achivedGoals);
	}
	
	public List<AchivedGoal> getAchivedGoals() {
		return achivedGoals;
	}
